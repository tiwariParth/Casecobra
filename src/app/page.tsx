          ...
          <div className="mx-auto grid max-w-2xl grid-cols-1 px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2 gap-y-16">
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="flex gap-4 mt-2">
                ...
                />
                <div className="flex flex-col">
                  <p className="font-semibold">Steph</p>
                  <div className="flex gap-1.5 items-center text-zinc-600">
                    <Check className="h-4 w-4 stroke-[3px] text-green-600" />
                    <p className="text-sm">Verified Purchase</p>
                  </div>
        ...
        <MaxWidthWrapper className="py-24">
          ...
          <div className="mx-auto max-w-6xl">
            <div className="relative flex flex-col items-center md:grid grid-cols-2 gap-40">
              ...
              />
              <div
                className="relateive h-80 md:h-full w-full md:justify-self-end max-w-sm rounded-xl bg-gray-900/5
              ring-inset ring-gray-900/10 lg:rounded-2xl"
              >
                <img
                  src="/horse.jpg"
                  alt=""
                  className="rounded-2xl object-cover bg-white shadow-2xl ring-1 ring-gray-900/10 h-full w-full"
                />
              </div>
